...
type UserServiceClient interface {
	...
	FindUserByEmail(ctx context.Context, in *FindUsersByEmailRequest, opts ...grpc.CallOption) (*FindUsersResponse, error)
	FindUserByID(ctx context.Context, in *FindUsersByIDRequest, opts ...grpc.CallOption) (*FindUsersResponse, error)
...
func (c *userServiceClient) FindUserByEmail(ctx context.Context, in *FindUsersByEmailRequest, opts ...grpc.CallOption) (*FindUsersResponse, error) {
...
func (c *userServiceClient) FindUserByID(ctx context.Context, in *FindUsersByIDRequest, opts ...grpc.CallOption) (*FindUsersResponse, error) {
	out := new(FindUsersResponse)
...
type UserServiceServer interface {
	...
	FindUserByEmail(context.Context, *FindUsersByEmailRequest) (*FindUsersResponse, error)
	FindUserByID(context.Context, *FindUsersByIDRequest) (*FindUsersResponse, error)
...
func (UnimplementedUserServiceServer) FindUserByEmail(context.Context, *FindUsersByEmailRequest) (*FindUsersResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindUserByEmail not implemented")
}
func (UnimplementedUserServiceServer) FindUserByID(context.Context, *FindUsersByIDRequest) (*FindUsersResponse, error) {
...
func _UserService_FindUserByEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).FindUserByEmail(ctx, req.(*FindUsersByEmailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_FindUserByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).FindUserByID(ctx, req.(*FindUsersByIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
